        ...
        <div className="at-user__avatar">
          <LazyImage
            href={UrlHelper.getUrlUserDetail({
              slugUser: itemUserDetail.slug
            })}
            src={getServerDirectUrl(itemUserDetail.profileUrl)}
            defaultImage={avatarDefaultUrl}
          />
        </div>
        <div className="at-user__name">
          <Link
            to={UrlHelper.getUrlUserDetail({
              slugUser: itemUserDetail.slug
            })}
          >
            {itemUserDetail.displayName}
          </Link>
        </div>
        <div className="at-user__title">Lovely User</div>
        <ul className="at-social">
          <li className="at-social__item">
            <Link
              to={UrlHelper.getUrlUserDetail({
                slugUser: itemUserDetail.slug
              })}
