        ...
        <g id="bell" fill={color}>
          {active ? (
            <g id="group-2">
              ...
              <path
                d="M17.97,8.5 L19.97,8.5 C19.82,5.3 18.24,2.48 15.85,0.65 L14.43,2.08 C16.45,3.53 17.82,5.85 17.97,8.5 Z"
                id="Path"
              />
              <path
                d="M5.58,2.08 L4.15,0.65 C1.75,2.48 0.17,5.3 0.03,8.5 L2.03,8.5 C2.18,5.85 3.54,3.53 5.58,2.08 L5.58,2.08 Z"
                id="Path"
              />
            </g>
          ) : null}
